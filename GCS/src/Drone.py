...
class Drone:
    ...
    def takeoff_drone(self):
        if DRONE_STATE.LANDED != self.drone_status: #TODO  this probably should happen in a different way. 
            return
    ...
    def set_speed(self):
        self.window_wrapper.create_window("Set Speed", title="Set Speed (m/s)", width=300, height=200)
        speed_value = self.window_wrapper.display_custom_window("Set Speed", message="Enter the desired speed:", input_prompt="Speed")
    ...
    def set_altitude(self):
        self.window_wrapper.create_window("Set Altitude", title="Set Altitude (m)", width=300, height=200)
        altitude_value = self.window_wrapper.display_custom_window("Set Altitude", message="Enter the desired altitude:", input_prompt="Altitude")
    ...
    def set_heading(self):
        self.window_wrapper.create_window("Set Heading", title="Set Heading (degrees)", width=300, height=200)
        heading_value = self.window_wrapper.display_custom_window("Set Heading", message="Enter the desired heading:", input_prompt="Heading")

...
px4_msgs::msg::TrajectorySetpoint PositionControl::turnByAngle(float angle_degrees)
{
    ...
    RCLCPP_INFO(this->get_logger(), "TRUN TURN TURN MESSAGE: %f, Y: %f, Z: %f", trajectory_setpoint_msg.position[0], trajectory_setpoint_msg.position[1], trajectory_setpoint_msg.position[2]);
